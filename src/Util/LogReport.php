...
class LogReport
{
     ...
     *
     * @param int $limit Maximum number of revisions to return, newest first.
     ...
     * @return string
     */
    public function createRequestBody(int $limit, ?int $startRevision = null, int $endRevision = 0): string
    {
