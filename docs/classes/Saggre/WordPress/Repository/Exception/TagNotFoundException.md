...
* Full name: `\Saggre\WordPress\Repository\Exception\TagNotFoundException`
* Parent class: [`\Saggre\WordPress\Repository\Exception\ClientException`](./ClientException)
